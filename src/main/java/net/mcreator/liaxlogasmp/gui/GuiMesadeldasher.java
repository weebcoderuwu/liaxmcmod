...
package net.mcreator.liaxlogasmp.gui;
...
import net.mcreator.liaxlogasmp.LiAxLoGasmp;
...
public class GuiMesadeldasher extends ElementsLiAxLoGasmp.ModElement {
	public static int GUIID = 1;
	public static HashMap guistate = new HashMap();
	public GuiMesadeldasher(ElementsLiAxLoGasmp instance) {
		super(instance, 6);
	}
	...
	public static class GuiContainerMod extends Container implements Supplier<Map<Integer, Slot>> {
		...
		public GuiContainerMod(World world, int x, int y, int z, EntityPlayer player) {
			...
			this.customSlots.put(0, this.addSlotToContainer(new Slot(internal, 0, 6, 20) {
			}));
			this.customSlots.put(1, this.addSlotToContainer(new Slot(internal, 1, 30, 52) {
			}));
			this.customSlots.put(3, this.addSlotToContainer(new Slot(internal, 3, 145, 14) {
			}));
			this.customSlots.put(4, this.addSlotToContainer(new Slot(internal, 4, 80, 38) {
				@Override
		...
		private void slotChanged(int slotid, int ctype, int meta) {
			if (this.world != null && this.world.isRemote) {
				LiAxLoGasmp.PACKET_HANDLER.sendToServer(new GUISlotChangedMessage(slotid, x, y, z, ctype, meta));
	...
	public static class GuiWindow extends GuiContainer {
		...
		private static final ResourceLocation texture = new ResourceLocation("liaxlogasmp:textures/mesadeldasher.png");
		@Override
		...
		protected void drawGuiContainerForegroundLayer(int par1, int par2) {
			this.fontRenderer.drawString("mesa  del dasher", 43, 4, -16777216);
		}
		...
		protected void actionPerformed(GuiButton button) {
			LiAxLoGasmp.PACKET_HANDLER.sendToServer(new GUIButtonPressedMessage(button.id, x, y, z));
