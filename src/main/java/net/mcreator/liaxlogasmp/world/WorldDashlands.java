...
package net.mcreator.liaxlogasmp.world;
...
import net.mcreator.liaxlogasmp.procedure.ProcedureDashlandsPlayerEntersDimension;
import net.mcreator.liaxlogasmp.procedure.ProcedureBonjurPlayerLeavesDimension;
import net.mcreator.liaxlogasmp.item.ItemDashlands;
import net.mcreator.liaxlogasmp.block.BlockLiAxSiTablock;
...
public class WorldDashlands extends ElementsLiAxLoGasmp.ModElement {
	public static int DIMID = 3;
	public static final boolean NETHER_TYPE = false;
	@GameRegistry.ObjectHolder("liaxlogasmp:dashlands_portal")
	public static final BlockCustomPortal portal = null;
	public static DimensionType dtype;
	public WorldDashlands(ElementsLiAxLoGasmp instance) {
		super(instance, 14);
	}
	...
	public void initElements() {
		...
		elements.items.add(() -> new ItemDashlands().setUnlocalizedName("dashlands").setRegistryName("dashlands"));
	}
	...
	public void preInit(FMLPreInitializationEvent event) {
		if (DimensionManager.isDimensionRegistered(DIMID)) {
			...
			System.err.println("Dimension ID for dimension dashlands is already registered. Falling back to ID: " + DIMID);
		}
		dtype = DimensionType.register("dashlands", "_dashlands", DIMID, WorldProviderMod.class, true);
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(ItemDashlands.block, 0, new ModelResourceLocation("liaxlogasmp:dashlands", "inventory"));
	}
	public static class WorldProviderMod extends WorldProvider {
		...
		public void onPlayerAdded(EntityPlayerMP entity) {
			...
			int z = (int) entity.posZ;
			{
				...
				ProcedureDashlandsPlayerEntersDimension.executeProcedure($_dependencies);
			}
		}
		...
		public void onPlayerRemoved(EntityPlayerMP entity) {
			...
			int z = (int) entity.posZ;
			{
				java.util.HashMap<String, Object> $_dependencies = new java.util.HashMap<>();
				$_dependencies.put("entity", entity);
				ProcedureBonjurPlayerLeavesDimension.executeProcedure($_dependencies);
			}
		}
	}
					...
					for (int l7 = 1; l7 < 3; ++l7) {
						for (int k8 = -1; k8 < 3; ++k8) {
							...
							this.world.setBlockState(new BlockPos(k9, k10, k11),
									flag ? BlockLiAxSiTablock.block.getDefaultState().getBlock().getDefaultState() : Blocks.AIR.getDefaultState());
						}
					}
				}
			}
				...
				for (int l8 = 0; l8 < 4; ++l8) {
					for (int l9 = -1; l9 < 4; ++l9) {
						...
						this.world.setBlockState(new BlockPos(l10, l11, k12),
								flag1 ? BlockLiAxSiTablock.block.getDefaultState().getBlock().getDefaultState() : iblockstate, 2);
					}
				}
	...
	public static class BlockCustomPortal extends BlockPortal {
		public BlockCustomPortal() {
			setHardness(-1.0F);
			setUnlocalizedName("dashlands_portal");
			setRegistryName("dashlands_portal");
			setLightLevel(0F);
		}
		...
		public static class Size {
			...
			protected int getDistanceUntilEdge(BlockPos p_180120_1_, EnumFacing p_180120_2_) {
				...
				for (i = 0; i < 22; ++i) {
					...
					if (!this.isEmptyBlock(this.world.getBlockState(blockpos).getBlock())
							|| this.world.getBlockState(blockpos.down()).getBlock() != BlockLiAxSiTablock.block.getDefaultState().getBlock()) {
						break;
					}
				}
				Block block = this.world.getBlockState(p_180120_1_.offset(p_180120_2_, i)).getBlock();
				return block == BlockLiAxSiTablock.block.getDefaultState().getBlock() ? i : 0;
			}
			...
			protected int calculatePortalHeight() {
				label56 : for (this.height = 0; this.height < 21; ++this.height) {
					for (int i = 0; i < this.width; ++i) {
						...
						if (i == 0) {
							...
							if (block != BlockLiAxSiTablock.block.getDefaultState().getBlock()) {
								break label56;
							}
				...
				for (int j = 0; j < this.width; ++j) {
					if (this.world.getBlockState(this.bottomLeft.offset(this.rightDir, j).up(this.height)).getBlock() != BlockLiAxSiTablock.block
	...
	public static class ChunkProviderModded implements IChunkGenerator {
		...
		private static final IBlockState STONE2 = Blocks.STONE.getStateFromMeta(5);
